...
VL_INLINE_OPT void Vsigdelay___024root___sequent__TOP__0(Vsigdelay___024root* vlSelf) {
    ...
    // Body
    __Vdly__sigdelay__DOT__count = vlSelf->sigdelay__DOT__count;
    __Vdlyvset__sigdelay__DOT__myRAM__DOT__ram_array__v0 = 0U;
    __Vdly__sigdelay__DOT__count = ((IData)(vlSelf->rst)
                                     ? 0U : (0xffU 
                                             & ((IData)(1U) 
                                                + (IData)(vlSelf->sigdelay__DOT__count))));
    if (vlSelf->rd_en) {
        vlSelf->dout = vlSelf->sigdelay__DOT__myRAM__DOT__ram_array
            [(0xffU & ((IData)(vlSelf->sigdelay__DOT__count) 
                       - (IData)(vlSelf->offset)))];
    }
    if (vlSelf->wr_en) {
        ...
        __Vdlyvdim0__sigdelay__DOT__myRAM__DOT__ram_array__v0 
            = vlSelf->sigdelay__DOT__count;
    }
    vlSelf->sigdelay__DOT__count = __Vdly__sigdelay__DOT__count;
